...
public class Curriculum_New_1_18{
	...
	public static void jou(int jou1 , int jou2) {
		System.out.println(jou1 * jou2);
	}
	
	// Q3：引数として整数の配列を渡すと、受け取った値を順番にコンソールに出力するメソッドを作成してください。
	// 整数メソッド[hai]を作成するし、引数を配列にする。
	public static void hai(int[] date) {
	...
	public static void jou(float jou1 , float jou2) {
	...
	// ※0は出力＆格納しないようにしてください。
    // 配列メソッド[ran]を作成する。
	public static int[] ran(int rand) {
	...
	public static double ave(int aveg) {
